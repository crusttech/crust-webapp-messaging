 ...
 *
 * Similar component is used in Compose & Admin apps
 */
export default {
  data () {
    return {
...
<style lang="scss">
// Mimicking bootstrap (from compose app) styles
...
.navbar {
  ...
  position: relative;
  background-color: #E85568 !important;
